...
const TestimonialsSection = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-slate-50 via-blue-50/30 to-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <motion.div
          ...
          className="text-center mt-16 lg:mt-20 pt-12 lg:pt-16 border-t border-slate-200"
        >
