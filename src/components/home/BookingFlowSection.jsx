...
const bookingSteps = [
  ...
  },
  {
    ...
    icon: MapPin,
    title: "Trip Details",
    description: "Specify your transportation needs and preferences",
...
const BookingFlowSection = () => {
  return (
    <section className="py-10 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950/20">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-display font-bold text-4xl md:text-6xl text-slate-900 dark:text-white mb-6">
            Simple <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Booking Process</span>
          </h2>
          
          <p className="text-slate-600 dark:text-slate-400 text-xl max-w-3xl mx-auto leading-relaxed">
            Get your corporate transportation arranged in just three easy steps. 
            Our streamlined process ensures quick and efficient booking for all your business travel needs.
          </p>
        </motion.div>
                ...
                <div className="relative h-full">
                  ...
                  >
                    ...
                    <div className="relative mb-8">
                      <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${step.color} text-white font-bold text-2xl shadow-lg shadow-slate-900/20 group-hover:scale-110 group-hover:shadow-xl transition-all duration-300`}>
                        {step.step}
                      </div>
                      <div className={`absolute -top-1 -right-1 w-6 h-6 rounded-full bg-gradient-to-br ${step.color} animate-pulse`} />
                    </div>

                    {/* Icon Container */}
                    <div className="mb-8">
                      <div className={`inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br ${step.color} bg-opacity-10 group-hover:bg-opacity-20 transition-all duration-300`}>
                        <step.icon className="w-10 h-10 text-slate-700 dark:text-slate-300 group-hover:scale-110 transition-transform duration-300" />
                      </div>
                    </div>
                    ...
                    <div className="mt-8 space-y-4">
                      {step.details.map((detail, detailIndex) => (
                        ...
                        >
                          <div className={`flex-shrink-0 w-3 h-3 rounded-full bg-gradient-to-r ${step.color} mt-1 animate-pulse`} />
                    ...
                    {/* Bottom Accent Line */}
                    <div className={`absolute bottom-0 left-8 right-8 h-1 bg-gradient-to-r ${step.color} rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
                  </motion.div>
                </div>
              </motion.div>
            ))}
