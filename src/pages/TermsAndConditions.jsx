  ...
  const sections = [
    {
      ...
      icon: CreditCard,
      content: [
        "The customer shall pay the car rental fare as per the applicable rates and payment schedules mentioned on the website of Sky Logistic at the time of booking",
        "The customer shall also pay parking charges, toll-charges, service tax, state tax and any other fee or levy presently payable or imposed hereinafter under applicable law/s for availing the car rental services",
    ...
    },
    {
      ...
      icon: AlertTriangle,
      content: [
        "The Customer agrees and acknowledges that the use of the services offered by Sky Logistic is at the sole risk of the Customer",
        "Sky Logistic disclaims all representations and warranties of any kind, whether express or implied as to condition, suitability, quality, merchantability and fitness of the services offered by Sky Logistic",
        "The liability of Sky Logistic is excluded to the fullest extent permitted by law",
        "Without prejudice to the above, Sky Logistic makes no representation or warranty that: the service shall meet Customer requirements; the service shall be uninterrupted, timely, secure, or error-free",
    ...
    {
      title: "Service Guarantees and Limitations",
      icon: Clock,
      content: [
    ...
    },
    {
      ...
      icon: MapPin,
      content: [
        "Sky Logistic is hereby authorized to use the location-based information provided by any of the telecommunication companies regarding the use of mobile phone by the Customer for making a taxi booking",
        "However, the location-based information will be used only to facilitate and improve the probability of locating a taxi for the Customer",
    ...
    {
      title: "Booking Termination and Cancellation",
      icon: Users,
      content: [
        ...
        "Sky Logistic encourages all its customers to take full responsibility of their luggage/belongings",
        "In case of any loss, from the taxi during the journey, Sky Logistic shall endeavour to locate the lost luggage/belongings on a 'best-effort' basis but Sky Logistic shall not be held responsible for such loss or damage",
    ...
    },
    {
      ...
      content: [
        ...
        "The Arbitrator so appointed by Sky Logistic shall act in conformity with the Arbitration and Conciliation Act, 1996",
        "The award so passed by the Arbitrator shall be binding upon the Customer as well as Sky Logistic",
        "The courts of Hyderabad, India shall have the sole and exclusive jurisdiction in respect of any matters which may be instituted before any court of law, arising from the use of the services offered by Sky Logistic"
      ]
    },
    {
      title: "Terms Modification and Communication",
      icon: Shield,
      content: [
        "Sky Logistic shall be entitled to add, vary or amend any or all of these terms and conditions at any time at its sole discretion and the Customer shall be bound by such addition, variation or amendment incorporated/made in these terms and conditions with effect from the date set forth by Sky Logistic",
        "The terms and conditions shall be available on Sky Logistic website www.skylogistic.com",
    ...
    },
    {
      ...
      content: [
        ...
        "While registering, the User will choose a password and the user is responsible for maintaining the confidentiality of the password and the account",
        "The User is fully responsible for all the activities that may take place whilst using their password or account",
        "It is the duty of the User to notify Sky Logistic immediately in writing of any unauthorized use of their password or account or any other breach of security",
        "Sky Logistic will not be liable for any loss that may be incurred by the User as a result of unauthorized use of customer's password or account, either with or without his/her knowledge",
    ...
    },
    {
      ...
      icon: FileText,
      content: [
        "Sky Logistic may send booking confirmation, itinerary information, cancellation, payment confirmation, refund status, schedule change or any such other information relevant for the transaction, via SMS or by voice call on the contact number given by the User at the time of booking",
        "Sky Logistic may also contact the User by voice call, SMS or email in case the User couldn't or hasn't concluded the booking, for any reason what so ever or to know the preference of the User for concluding the booking and also to help the User for the booking",
    ...
    },
    {
      ...
      icon: Shield,
      content: [
        "The User warrants that the User shall abide by all such additional procedures and guidelines, as modified from time to time, with respect to the use of Sky Logistic services",
        "The User further warrants that the User shall comply with all the applicable laws and regulations regarding the services provided by Sky Logistic",
        ...
        "Insurance cover, if any provided as a part of the service/ product by Sky Logistic shall be based on the terms and conditions of the insuring company",
        "The User shall contact the insurance company directly for any claim/s or dispute/s which may arise out of such insurance cover",
        "Sky Logistic shall not provide any express or implied undertakings for acceptance of the claims by the insurance company"
      ]
    }
  ];

  const keyPoints = [
    "All payments must be completed as per the specified terms and conditions",
    "Services are provided at customer's sole risk with limited liability",
    "Sky Logistic reserves the right to terminate bookings without prior notice",
    "Customers are responsible for their belongings and must report issues within 2 hours",
    "Disputes are subject to arbitration in Hyderabad, India",
    "Terms may be modified at any time and customers are bound by changes",
    "Account security and password protection are customer's responsibility",
    "Communications are transactional and comply with TRAI regulations"
  ];
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 max-w-2xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                <div>
                  ...
                  <p className="text-indigo-100 mb-1">Email: legal@skylogistic.com</p>
                  <p className="text-indigo-100">Phone: +91-1800-XXX-XXXX</p>
                </div>
                <div>
                  <h3 className="font-semibold text-white mb-2">General Support</h3>
                  <p className="text-indigo-100 mb-1">Email: info@skylogistic.com</p>
                  <p className="text-indigo-100">Phone: +91-1800-XXX-XXXX</p>
                </div>
              </div>
            </div>
